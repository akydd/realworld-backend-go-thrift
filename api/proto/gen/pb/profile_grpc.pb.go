...
const (
	...
	ProfileService_FollowUser_FullMethodName   = "/ProfileService/FollowUser"
	ProfileService_UnfollowUser_FullMethodName = "/ProfileService/UnfollowUser"
)
...
func (c *profileServiceClient) FollowUser(ctx context.Context, in *FollowUserRequest, opts ...grpc.CallOption) (*ProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProfileResponse)
...
func (c *profileServiceClient) UnfollowUser(ctx context.Context, in *UnfollowUserRequest, opts ...grpc.CallOption) (*ProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProfileResponse)
...
func (UnimplementedProfileServiceServer) FollowUser(context.Context, *FollowUserRequest) (*ProfileResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FollowUser not implemented")
}
func (UnimplementedProfileServiceServer) UnfollowUser(context.Context, *UnfollowUserRequest) (*ProfileResponse, error) {
