...
const (
	TagService_GetTags_FullMethodName = "/TagService/GetTags"
)
...
func (c *tagServiceClient) GetTags(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*TagsResponse, error) {
...
func (UnimplementedTagServiceServer) GetTags(context.Context, *emptypb.Empty) (*TagsResponse, error) {
